    ...
    <div className='text-indigo-500 space-x-4'>
      ...
      <div className='flex w-[97%] mx-auto py-4 px-56 shadow-sm justify-between'>
        ...
        <ul className="flex text-gray-800 gap-4 uppercase font-semibold">
          <li className='underline-animation'><NavLink to="/">Home</NavLink></li>
          <li className='underline-animation'><NavLink to="/about">About</NavLink></li>
          <li className='underline-animation'><NavLink to="/movie">Movie</NavLink></li>
          <li className='underline-animation'><NavLink to="/contact">Contact</NavLink></li>
        </ul>
      </div>
